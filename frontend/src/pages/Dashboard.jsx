...
import {
  ...
  comparisonRows,
  regionOpportunities,
  indiaOpportunityIndex,
  indiaScoreComponents,
  portfolioStats,
  decisionForScore,
  SCORE_WEIGHTS,
} from "../lib/engine";
    ...
    <div className="rounded-md border border-[#E2E8F0] bg-white px-3 py-2 shadow-lg text-xs">
      ...
      {payload.map((p, i) => (
        ...
        >
          ...
          <span className="stat-num text-[#0F172A]">
...
export default function Dashboard() {
  ...
  const branchData = rows.map((r) => ({
    name: r.short,
    value: r.branches,
  }));


  const depositData = rows.map((r) => ({
    name: r.short,
    value: Math.round(r.deposits / 1000),
  }));
  ...
  const kpis = [
    {
      ...
      icon: Landmark,
      label: "Banks Analysed",
      value: String(stats.banks).padStart(2, "0"),
      context: "Public + Private sector",
      variant: "dark",
    },

    {
      testid: "kpi-card-regions",
      icon: Globe2,
      label: "Regions Evaluated",
      value: `${stats.regions}+`,
      context: "States & metro clusters",
    },

    {
      testid: "kpi-card-branches",
      icon: Building2,
    ...
    {
      testid: "kpi-card-deposits",
      icon: Layers,
      label: "Deposits Analysed",
  ...
  return (
    ...
    >
          ...
          >
            ...
            <div>
              ...
              <p
                ...
                "
              >
                A consulting-grade command centre for branch expansion,
                network optimisation and market whitespace across India.
              </p>
              ...
              >
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <Select
                    value={dbBank}
                    onValueChange={setDbBank}
                  >

                    <SelectTrigger
                      data-testid="dashboard-bank-filter"
                      className="
                        h-9
                        w-[200px]
                        rounded-xl
                ...
                <div className="flex flex-col gap-1">
                  ...
                  >
                    ...
                    <SelectTrigger
                      data-testid="dashboard-region-filter"
                      className="
                        h-9
                        w-[190px]
                        rounded-xl
            ...
            >
              ...
              >
                ...
                {" "}The current opportunity index is{" "}
      ...
      >
        ...
        <div
          className="
            ...
            text-center
          "
          data-testid="opportunity-index-card"
        >
        ...
        >
          ...
          >
            ...
            {SCORE_WEIGHTS.map((w) => (
              ...
              <ScoreBar
                key={w.key}
                testid={`component-${w.key}`}
                label={`${w.label} · ${Math.round(
                  w.weight * 100
                )}%`}
      ...
      <section>
        ...
        <SectionTitle
          eyebrow="Regional Banking Opportunity"
          title="Where should banks expand next?"
          subtitle="Colour intensity reflects the BranchIQ opportunity score across markets."
          right={
            <DataBadge
              type="analytical"
            />
      ...
      <section>
        ...
        <SectionTitle
          ...
          subtitle="Ranked market opportunities generated by the BranchIQ analytical framework."
